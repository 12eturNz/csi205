...
function PageCalculator() {
  ...
  // --- เพิ่ม: ฟังก์ชันหลอกสำหรับปุ่ม Memory (ทำให้คลิกได้) ---
  function mcClicked() {
    alert("Memory Clear (MC) clicked - Not implemented yet!");
  }

  function mrClicked() {
    alert("Memory Recall (MR) clicked - Not implemented yet!");
  }
  // -----------------------------------------------------------
  ...
  return (
    <div className="cal-container" role="application" aria-label="เครื่องคิดเลข">
      ...
      {/* แก้ไข: ลบ disabled ออกจากปุ่ม MC, MR และเพิ่ม onClick */}
      <div className="row">
        <button className="cal-btn cal-btn-green" id="mc" onClick={mcClicked}>MC</button>
        <button className="cal-btn cal-btn-green" id="mr" onClick={mrClicked}>MR</button>
