...
// Toolbar Component
function Toolbar({ showWaitingOnly, setShowWaitingOnly, itemsPerPage, onItemsPerPageChange, onAddClick }) {
  return (
    <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={onAddClick}
          className="w-10 h-10 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors flex items-center justify-center text-xl font-bold"
        >
          +
        </button>
      </div>
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white border border-gray-300 shadow-xl rounded-xl w-[90%] md:w-[80%] lg:w-[70%] p-6">
        ...
        <Toolbar 
          ...
          setShowWaitingOnly={setShowWaitingOnly} 
          itemsPerPage={itemsPerPage} 
          onItemsPerPageChange={handleFilterOrPageChange} 
